...
export interface GenerationTask {
  ...
  code?:string;craftPlan?:Record<string,unknown>;handoffInstructions?:string;texturePrompt?:string;phase?:'planning'|'building'|'checking'|'texture-preparing'|'texture-uploading'|'texture-submitting'|'texturing'|'texture-checking'|'pattern-generating'|'pattern-applying';
