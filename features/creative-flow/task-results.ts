...
export interface GenerationTask {
  ...
  createdAt:number; dismissed:boolean; error?:string; note?:string; handoffMessage?:string; dispatch?:string; targetName?:string;
  result?: { title?:string;brief?:string;culture?:string;sections?:Record<string,string>;replacement?:string;notes?:string;art?:Project['art'];objects?:Pick<Concept,'id'|'category'|'name'|'description'>[];asset?:ImageAsset;novel?:Project['novel'];videoPlan?:VideoDraft;videoClip?:MediaFile;videoAudio?:MediaFile;videoFinal?:VideoDraft['final'];website?:WebsiteDraft };
}
