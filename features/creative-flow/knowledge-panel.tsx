...
export function KnowledgePanel({project,edit}:{project:Project;edit:EditProject}) {
  ...
  return <section className="surface knowledge-panel" aria-label="岭南文化依据">
    ...
    <ThemeAssetsPanel project={project} edit={edit}/><Field label="当前项目的文化语境" hint="填写地域、时代、虚构设定与待核实细节；资料选择不会覆盖这里的文字。"><textarea rows={3} value={project.culture} placeholder="例如：当代广州街区的虚构故事；具体店铺与人物为原创。" onChange={event=>edit(p=>({...p,culture:event.target.value}))}/></Field>
