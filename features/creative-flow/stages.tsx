...
export function ContentStage({ project, edit, unavailable }: StageProps) {
...
export function ImagePreview({ asset, onClose }: { asset: ImageAsset; onClose: () => void }) { return <Modal title={asset.name} subtitle="按原图显示，不叠加界面色彩或纹理。" onClose={onClose} wide><AssetImage asset={asset} alt={asset.name} className="lightbox-image" /></Modal>; }
...
export function ConceptsStage({ project, edit, notice, unavailable, demo, demoState }: StageProps) {
...
export function FinalStage({ project, edit, demo, demoState, notice }: StageProps) {
