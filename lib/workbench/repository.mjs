...
import { mkdir, readFile, rename, writeFile, readdir, realpath, stat, link, unlink } from 'node:fs/promises';
...
export function createRepository(directory) {
  ...
  return { root, initialize, loadWorkspace, recoverWorkspace, saveWorkspace, coreReceipt, mutateProject, inbox, readInbox, exportText, readExport, putImage, media, putOutput, output, listTasks, task, saveTask, handoff, readHandoff, completeImageHandoff };
}
