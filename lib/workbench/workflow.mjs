...
export const BRANCH_FIELDS = ['brief','art','references','concepts','delivery','requests','novel','novelReferenceIds','video','website','websiteBrief','websiteEdit','studioRevision','websiteRequest','websiteSource','websiteSourceCandidate','designPackage','transfer','transfers'];
...
const owner={novel:'novel',novelReferenceIds:'novel',video:'video',website:'website',websiteRequest:'website',websiteBrief:'website',websiteEdit:'website',websiteSource:'website',websiteSourceCandidate:'website'};
