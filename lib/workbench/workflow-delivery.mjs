...
export async function prepareDesignPackage(task,{repository}) {
  ...
  const brief={type:p.type,title:p.title,idea:p.idea,brief:p.brief,culture:p.culture,themeKnowledge:knowledgeText(p),content:p.content[p.type],art:p.art,delivery:p.delivery,assets:roles,
