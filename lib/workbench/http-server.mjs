...
export function createRuntimeServer({ env = process.env, fetchImpl = fetch, dataDirectory, settingsPath = fileURLToPath(new URL('../../work/service-settings.json', import.meta.url)) } = {}) {
  env = { ...env };
