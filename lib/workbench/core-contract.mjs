...
const patch = z.object({
  ...
  websiteRequest: z.object({ prompt:text, basis:z.string().max(500000), assetIds:z.array(id).max(100), bundleFileId:z.string().regex(/^[a-f0-9]{64}\.zip$/).optional(), source:z.string().max(500000).optional(), taskId:id.optional() }).strict().optional(),
